    ...
    <>
      <div className="flex w-full h-banner">
        ...
        <div className={`w-[calc(100%-70rem)] bg-white`}>
          <div className={`relative top-[16rem] left-[5rem] w-[37rem] text-black ${props.animation}`}>
            <p className="mb-[1rem] font-bold text-[2rem]">{props.text.bannerTitle}</p>
            <p className="text-[#A5A5A5] text-[1.2rem]">{props.text.bannerDescription}</p>
            <Link
              to={props.path}
