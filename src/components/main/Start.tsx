...
const Start = () => {
  return (
    <section className="relative w-full h-[53rem] bg-gradient-to-r from-[#00AFFF] from-10% via-[#00CDFF] via-30% to-main-color to-90%">
      <div className="ml-[19rem] pt-[10rem] w-[27rem]">
        ...
        <Link
          ...
          className="px-10 py-6 hover:bg-white border border-white rounded-xl font-bold text-white hover:text-[#00AFFF] text-2xl"
        >
          시작하기
        </Link>
      </div>
