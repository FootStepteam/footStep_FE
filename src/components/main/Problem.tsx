const Problem = () => {
  return (
    <section className="w-full h-[58rem] bg-[#F5F5F5]">
      ...
      <div className="grid grid-cols-4 m-center mt-16 px-4 py-4 w-[90rem]">
        <div className="flex flex-col justify-center items-center w-80 h-48 bg-white border border-[#DCDCDC] rounded-3xl text-2xl shadow-lg">
