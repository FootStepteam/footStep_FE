...
const PlaceSearchArea = ({ placeSearch }: IPropsPlaceSearch) => {
  ...
  return (
    <div className="relative shadow-lg">
      ...
      <div
        className={`${sidebarOpenState.placeSearch ? 'block' : 'hidden'} flex justify-center items-center absolute top-[50%] right-[-6%] w-6 h-16 bg-white rounded-r-xl cursor-pointer`}
